...
PM_START_TEXT = """
Hello, I'M Nicky
`I'M HERE TO HELP YOU MANAGE YOUR GROUPS...! ` /help
Maintained by Akshay Chand ❤
"""

buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ADD TO YOUR GROUP ➕️", url="t.me/MissNicky_bot?startgroup=true"),
    ],
    [
    ...
    [
        InlineKeyboardButton(text="Movie request Group", url=f"https://t.me/+CG7AQS6IfUNhYTNl"),
        InlineKeyboardButton(
            text="Movie Update Channel", url=f"https://t.me/+1qdEeHOTLdQ1M2Vl"
        ),
    ],
    [
...
HELP_STRINGS = """
`Hi.. I'M` Nicky
`Click on the Buttons Below To Get Documentation About Special Modules....`
Powered by :- [Akshay chand](t.me/+CG7AQS6IfUNhYTNl)"""

layla_IMG = "https://telegra.ph/file/524b78577a42b02b2f074.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project [Hero](t.me/+CG7AQS6IfUNhYTNl) \
 Supporting isnt always financial! [AwesomeSupport](t.me/+CG7AQS6IfUNhYTNl) \
    ...
    if query.data == "layla_":
        query.message.edit_text(
            text=""" ℹ️ I'm *Nicky*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \n\n_Nicky licensed under the GNU General Public License v3.0_                 
                 \n❍ Support Group @NICKYSUPPORTCHAT
                 \n❍ Assistant @Akshaymh17.                 
                 \n\nIf you have any question about Nicky, let us know at .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
